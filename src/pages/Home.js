    ...
    <div className="home">
      <div className="about">
        ...
        <BiCode/><p>Software/Web/Game Dev || Editor || Multimedia || Design </p>
                <h4>I see myself as a proactive person that never gives up when trying to reach a certain goal. 
                    My values are, were and always will be: work and rigor, either in my personal life or in my professional life.
                    ...
                    I also spent a lot of my free time as a indie game dev and as freelancing video/photo editor.</h4>
